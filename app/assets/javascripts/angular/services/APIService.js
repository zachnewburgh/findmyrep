APIService = ['$http', function($http) {
  ...
  this.getFederal = function(lat, lng) {
    return $http.get('https://congress.api.sunlightfoundation.com/legislators/locate?origin=*&latitude=' + lat + '&longitude=' + lng + '&apikey=' + sunlight_key, {headers: {Authorization: undefined}});
  };
